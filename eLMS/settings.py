...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the NICARB",
    ...
    "topmenu_links": [
        ...
        {"name": "Quiz", "url": "http://127.0.0.1:8000/admin/quiz/quiz/"},
        {"name": "Courses", "url": "http://127.0.0.1:8000/admin/main/course/"},
